<x-layouts.admin title="Manajemen Lokasi">
                ...
                <tbody>
                    @forelse ($locations as $index => $location)
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-sm btn-primary mr-2" onclick="openEditModal(this)" data-id="{{ $location->id }}" data-nama="{{ $location->nama_lokasi }}">Edit</button>
    ...
    <!-- Edit Category Modal With Retrieve ID -->
     <dialog id="edit_modal" class="modal">
        <form method="POST" class="modal-box">
            ...
            <input type="hidden" name="category_id" id="edit_location_id">
            ...
            <div class="form-control w-full mb-4">
                ...
                <input type="text" placeholder="Masukkan nama lokasi" class="input input-bordered w-full" value="Kategori Contoh" id="edit_location_name" name="nama_lokasi" />
            </div>
            <div class="modal-action">
                <button class="btn btn-primary" type="submit">Simpan</button>
    ...
    <dialog id="delete_modal" class="modal">
        <form method="POST" class="modal-box">
            ...
            <input type="hidden" name="category_id" id="delete_location_id">
